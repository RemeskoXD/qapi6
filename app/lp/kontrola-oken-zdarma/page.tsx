...
export default function KontrolaOkenZdarmaPage() {
  return (
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="mt-12 p-6 rounded-2xl bg-white/5 border border-white/10 relative">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Marie Novotná</div>
                  <div className="text-white/50 text-xs">Spokojená zákaznice</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative">
              <LpForm 
                leadMagnetName="Bezplatná kontrola oken - LP" 
                ...
                thankYouText={
                  <>
                    ...
                    <span className="text-primary font-bold">Poslední krok:</span> Vyberte si prosím termín, který vám nejvíce vyhovuje, přímo v našem kalendáři.
                  </>
                }
                nextStepText="Vybrat termín v kalendáři"
              />
            </div>
          </div>
